...
namespace StealthMonitoring.NasaImages.WebApp
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IImageRepository>(p => new FileSystemImageRepository(GetImageGalleryPath(Configuration)));
        ...
        private static string GetImageGalleryPath(IConfiguration config)
        {
